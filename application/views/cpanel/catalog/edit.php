<div id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <?php echo form_open_multipart('',array('id'=>'catalog_edit'));
        ...
        <div class="page-content inset">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="main">
                    ...
                    <div class="row bestmedia-input">
                        <div class="col-md-6 col-sm-8 col-xs-12 col-lg-4">
                            <label class="control-label">Транслитерация раздела</label>
                    ...
                    <div id="constructed" style="margin-bottom: 50px;">
                        <?php echo $constructed_data; ?>
                    </div>
                    <!--/HERE-->
