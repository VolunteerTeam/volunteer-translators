    ...
    <div id="page-content-wrapper">
        ...
        <div class="page-content inset">
            ...
            <div class="tab-content">
                <div class="tab-pane active col-md-12" id="main">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                <select data-placeholder="Выберите адреса" style="width:350px;" multiple name="addresses[]" class="chosen form-control">
                                    <?php
                                    foreach ($addresses as $address) {
                                        echo '<option value="'.$address->id.'">'.$address->title.'</option>';
                                    }
                                    ?>
                                </select>
                            </div>
