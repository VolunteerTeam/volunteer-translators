    ...
    <div id="page-content-wrapper">
        <div class="content-header">
            <div class="col-md-10 col-sm-10 col-xs-10">
                ...
                <ol class="breadcrumb">
                    <li class="active">Восстановление доступа</li>
                </ol>
            </div>
        ...
        <div class="page-content inset">
            <?php echo $message; ?>
            <?php echo form_open('',array('id'=>'restore_form')); ?>
            <div class="form-group">
                <label for="email">Email</label>
                <?php echo form_input($email);?>

            </div>
            <button type="submit" name="do_restore" value="1" class="btn btn-default">Сбросить</button>
            </form>
        </div>
    </div>
</div>
