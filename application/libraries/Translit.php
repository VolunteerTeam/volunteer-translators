...
class CI_Translit {
    ...
    public  function convert($string, $separator = '-',$cleanPunctuation = TRUE, $cleanSlash = TRUE)
    {
        ...
        if ($cleanPunctuation)
        {
            $punctuation = $this->punctuationChars();
        ...
        $output = $this->cleanSeparators($output, $separator);
     ...
     */
    public function cleanSeparators($string, $separator = NULL, $toLowCase = TRUE)
    {
        $output = $string;
     ...
     */
    public function punctuationChars()
    {
        // Handle " ' ` , . - _ : ; | { [ } ] + = * & % ^ $ # @ ! ~ ( ) ? < > \
        return array(
            "double_quotes"=>'"',
