...
$hosts_array = array(
    'polaroid.rekastudio.ru'              =>'7U0S0000G00F6000000000000X0',
    'polaroidrussia.com'                =>'210B0000Q003200000000000060'


);

$config['LicenseName'] = $_SERVER['HTTP_HOST'];
$config['LicenseKey'] = $hosts_array[$_SERVER['HTTP_HOST']];
...
ATTENTION: The trailing slash is required.
*/
$baseDir =$_SERVER['DOCUMENT_ROOT'].'/content/other/';
//resolveUrl($baseUrl);
...
$config['plugin_imageresize']['smallThumb'] = '107x107';
$config['plugin_imageresize']['mediumThumb'] = '166x166';
$config['plugin_imageresize']['largeThumb'] = '338x166';
